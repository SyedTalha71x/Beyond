...
export default function Index() {
    return (
        <div className={montserrat.className}>
            <div className="container mx-auto mt-20 " id="newarrival">
                <h1 className="flex justify-center text-center text-3xl text-black uppercase tracking-wider">Best Selling</h1>
                            ...
                            <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                                <Slider>
                                    <div id="slider" className="h-full flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700">
                                        <Slide index={0}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/products/YLAJohnnyD3-14-52_400x.jpg?v=1678817409" alt="black chair and white table" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={1}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/products/323A2217_400x.jpg?v=1678817409" alt="sitting area" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={2}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/YLA_12.133_400x.jpg?v=1705433242" alt="sitting area" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={3}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/YLA_12.1134_400x.jpg?v=1705434741" alt="sitting area" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={4}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/YLA_1.3_400x.jpg?v=1705434694" alt="black chair and white table" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={5}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/323A5955_9975c347-2baf-4cbf-8897-8986a53db2ba_400x.jpg?v=1702329821" alt="sitting area" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={6}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/323A6006_400x.jpg?v=1701978278" alt="sitting area" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={7}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/425_black_002_11_02_johnny_lifestyle_400x.jpg?v=1707522156" alt="sitting area" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={8}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/YLA_1143.6_400x.jpg?v=1707522155" alt="black chair and white table" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={9}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/425_off-white_001_11_02_johnny_lifestyle_400x.jpg?v=1707522155" alt="sitting area" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={10}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/products/YLAGlobalSuperShoot-83_400x.jpg?v=1700094261" alt="sitting area" className="object-cover object-center w-full" />

                                            </div>
                                        </Slide>
                                        <Slide index={11}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                <Image height={400} width={600} src="https://www.youngla.com/cdn/shop/files/YLAGlobalSuperShoot-90_1_400x.jpg?v=1687895544" alt="sitting area" className="object-cover object-center w-full" />
