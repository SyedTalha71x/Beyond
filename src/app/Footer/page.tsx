...
const Page = () => {
    return (
        <div className={montserrat.className}>
            <footer className=" bg-[#00000B] px-10 py-14">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-8">
                    <div className="xl:col-span-2">
                        <a href='javascript:void(0)'><h1 className='text-gray-300 text-2xl font-extrabold uppercase tracking-wider'>Beyound Era</h1></a>
                    ...
                    <div>
                        <h4 className="text-white font-semibold text-lg relative max-sm:cursor-pointer uppercase">Services <svg
                    ...
                    <div>
                        <h4 className="text-white font-semibold text-lg relative max-sm:cursor-pointer uppercase">Platforms <svg
                            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                            className="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
                            <path
                                d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
                    ...
                    <div>
                        <h4 className="text-white font-semibold text-lg relative max-sm:cursor-pointer uppercase">Company <svg
                            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                            className="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
                            <path
                                d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
                        ...
                        <ul className="space-y-5 mt-4 max-sm:hidden">
                            <li>
                                <Link href='/About' className='hover:text-white text-gray-300 text-sm'>About us</Link>
                            </li>
                            <li>
                    ...
                    <div>
                        <h4 className="text-white font-semibold text-lg relative max-sm:cursor-pointer uppercase">Additional <svg
                            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                            className="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
                            <path
                                d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
                        ...
                        <ul className="space-y-5 mt-4 max-sm:hidden">
                            ...
                            <li>
                                <Link href='/Contact' className='hover:text-white text-gray-300 text-sm'>Contact</Link>
                            </li>
                            <li>
                ...
                <div className="flex max-md:flex-col gap-4">
                    ...
                    <p className='text-gray-300 text-sm md:ml-auto'>Copyright © 2023<a href='https://readymadeui.com/'
                        target='_blank' className="hover:underline mx-1">Beyond</a>All Rights Reserved.</p>
                </div>
            </footer>
        </div>
    )
