                        ...
                        <div className="flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                            ...
                            <div className="mt-4 md:mt-6 flex  flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full ">
                                <div className="pb-4 md:pb-8 w-full md:w-40">
                                    <Image height={400} width={600} className="w-full hidden md:block" src="https://www.youngla.com/cdn/shop/files/03_28_24_YLA_Her_Floor___SM0090_1_400x.jpg?v=1710870412" alt="dress" />
                                    <Image height={400} width={600} className="w-full md:hidden" src="https://www.youngla.com/cdn/shop/files/03_28_24_YLA_Her_Floor___SM0090_1_400x.jpg?v=1710870412" alt="dress" />
                                </div>
                                <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full  pb-8 space-y-4 md:space-y-0">
                                    <div className="w-full flex flex-col justify-start items-start space-y-8">
                                        <h3 className="text-xl xl:text-2xl font-semibold leading-6 text-gray-800">W612 WATER BOTTLE MINI</h3>
                                        <div className="flex justify-start items-start flex-col space-y-2">
                                            <p className="text-sm leading-none text-gray-800">
                                                <span className="text-gray-300">Size: </span> Small
                                            </p>
                                            <p className="text-sm leading-none text-gray-800">
                                                <span className="text-gray-300">Color: </span> MAX BLACK
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="mt-6 md:mt-0 flex justify-start flex-col md:flex-row  items-start md:items-center space-y-4  md:space-x-6 xl:space-x-8 w-full ">
                                <div className="w-full md:w-40">
                                    <Image height={400} width={600} className="w-full hidden md:block" src="https://www.youngla.com/cdn/shop/files/DSC05971_400x.jpg?v=1712252994" alt="dress" />
                                    <Image height={400} width={600} className="w-full md:hidden" src="https://www.youngla.com/cdn/shop/files/DSC05971_400x.jpg?v=1712252994" alt="dress" />
                                </div>
                                <div className="  flex justify-between items-start w-full flex-col md:flex-row space-y-4 md:space-y-0  ">
                                    <div className="w-full flex flex-col justify-start items-start space-y-8">
                                        <h3 className="text-xl xl:text-2xl font-semibold leading-6 text-gray-800">4038 - LAH CASA SHIRTS</h3>
                                        <div className="flex justify-start items-start flex-col space-y-2">
                                            <p className="text-sm leading-none text-gray-800">
                                                <span className="text-gray-300">Size: </span> SMALL
                                            </p>
                                            <p className="text-sm leading-none text-gray-800">
                                                <span className="text-gray-300">Color: </span> BLUE
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex justify-between space-x-8 items-start w-full">
                        ...
                        <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                            ...
                            <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                                ...
                                <div className="w-full flex justify-center items-center">
                                    <button className="hover:bg-black checkoutbtn focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-5 w-96 md:w-full bg-gray-800 text-base font-medium leading-4 text-white">View Carrier Details</button>
                                </div>
                            </div>
                        </div>
                    </div>
